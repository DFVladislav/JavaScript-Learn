...
Сайт диаграмм - adddiagram

Проектирование - это процесс  визуализации и описания основных подпроцессов работы системы
Мы должны схематично показать как работают крестики-нолики

Нотация (общепринятая документация которая описывает с помощью каких инструментов можно описать) UML - очень популярная нотация

C4 - визуализация архитектуры, остальное можно на UML

![alt text](image-3.png)

BPMN - визуализация бизнес процессов 

![alt text](image-2.png)

UML предоставляет диаграммы вариантов использования
...
Крестики нолики будем рассматривать через блок-схемы
...
HTTP - методы.
Основные - get, post, put, patch, delete 

Все эти методы привязываются к маршрутам (routes)

Условный get => dns.ru

Если сервер клиента запросит метод get он показывает что будет выдавать (пишем асинхронную функцию, чаще всего массив объектов) инфу из БД
будем с postgreSQL работать

КЛИЕНТ != получает доступ к бэкенду ни за что


API, по одному маршруту могут реализовываться все методы



Алгоритм морского боя блок схема


ДИАГРАММА СОСТОЯНИЙ
<img width="737" height="640" alt="image" src="https://github.com/user-attachments/assets/fdb24aa8-766b-4428-bd90-deee1fb4049c" />




ДИАГРАММА ПОСЛЕДОВАТЕЛЬНОСТИ ДЕЙСТВИЙ
<img width="750" height="303" alt="image" src="https://github.com/user-attachments/assets/999b732a-097b-4e69-9aae-c6fbd865df32" />


ДИАГРАММА КЛАСОВ
<img width="668" height="489" alt="image" src="https://github.com/user-attachments/assets/fa3d6e87-5d31-453b-9091-fb11b9b6c489" />
